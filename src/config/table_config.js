// Definition of tables to be synchronized and all fields present in the DB
export const SYNC_CONFIG = {
    ...
    "CURRENCYFORMATS_V1": {
        ...
        "unique": ["CURRENCYNAME", "CURRENCY_SYMBOL"] /* due unique separati */
    },
    "CATEGORY_V1": {
        "pk": "CATEGID",
        "fields": [
...
// Sync order to respect Foreign Key dependencies
export const SYNC_ORDER = [
    ...
    'CATEGORY_V1', // Self-referencing (PARENTID)
    'PAYEE_V1',    // Depends on CATEGORY_V1
    'ACCOUNTLIST_V1', // Depends on CURRENCYFORMATS_V1
...
// Mapping of primary key column names to referencing foreign key column names
export const FK_MAP = {
    'ACCOUNTID': ['ACCOUNTID', 'TOACCOUNTID'],
    'CATEGID': ['CATEGID', 'PARENTID'],
    'PAYEEID': ['PAYEEID'],
    'CURRENCYID': ['CURRENCYID'],
    'TAGID': ['TAGID'],
    'BUDGETYEARID': ['BUDGETYEARID'],
    'FIELDID': ['FIELDID'],
    'TRANSID': ['TRANSID', 'CHECKINGACCOUNTID'],
    'ASSETID': ['ASSETID'],
    'STOCKID': ['STOCKID']
};
